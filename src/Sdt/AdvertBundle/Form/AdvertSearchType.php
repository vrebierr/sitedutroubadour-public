...
class AdvertSearchType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('category', 'entity', array(
                'class' => 'Sdt\AdvertBundle\Entity\AdvertCategory',
                'required' => true,
                ))
            ...
            ->add('ageMin', 'integer', array('required' => true,))
            ->add('ageMax', 'integer', array('required' => true,))
    ...
    {
        return 'sdt_advertbundle_advertsearchtype';
    }
}
